  ...
  return (
    <div className="rapor-container">
      <header className="rapor-header">
        <div className="rapor-header-content">
          <div>
            ...
            <h1>Satış Kanalı Bazlı Rapor</h1>
          </div>
          <div className="nav-menu-container">
            ...
            {showNavMenu && (
              <div className="nav-menu-dropdown">
                ...
                <Link to="/satis/kanal" className="nav-menu-item active" onClick={() => setShowNavMenu(false)}>
                  🏪 Satış Kanalı
                </Link>
      ...
      <div className="stats-grid">
        ...
        {enCokSatanKanal && (
          <div className="stat-card">
            <div className="stat-label">En Çok Satan Kanal</div>
            <div className="stat-value" style={{ fontSize: '1.2rem' }}>{enCokSatanKanal.name}</div>
      ...
      <div className="charts-grid">
        <div className="chart-card">
          <h2>Kanal Bazında Satış Adetleri</h2>
