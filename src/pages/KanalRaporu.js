...
const KanalRaporu = () => {
  ...
  if (loading) {
    return (
      <div className="dashboard-page">
        <Header pageTitle="SATIŞ RAPORU (Satış Kanalı)" breadcrumb="Anasayfa > Satış > Satış Kanalı >" />
  ...
  const enCokSatanKanal = chartData.length > 0 ? chartData[0] : null;
  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-content">
          ...
          <div className="period-grid">
            ...
            {enCokSatanKanal && (
              <div style={{ 
                ...
                <div style={{ fontSize: '0.9rem', marginBottom: '0.5rem' }}>En Çok Satan Kanal</div>
                <div style={{ fontSize: '1.2rem', fontWeight: '700' }}>{enCokSatanKanal.name}</div>
                <div style={{ fontSize: '0.85rem', color: '#b0b0b0', marginTop: '0.5rem' }}>
                  {enCokSatanKanal.toplamAdet.toLocaleString('tr-TR')} adet
                </div>
              </div>
            )}
          </div>
        ...
        <div className="dashboard-section">
          <h3 className="subsection-title">Kanal Bazında Satış Adetleri</h3>
          <div className="period-grid">
            ...
            <div className="chart-container">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={filteredMonthlyData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="adet" stroke="#00f2fe" strokeWidth={2} name="Satış Adeti" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <thead>
              <tr>
                ...
                <th 
                  ...
                  style={{ cursor: 'pointer' }}
                >
                  Toplam Satış İçindeki Payı {sortColumn === 'payi' && (sortDirection === 'asc' ? '↑' : '↓')}
                </th>
              </tr>
            </thead>
            <tbody>
