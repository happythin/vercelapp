    ...
    <div className="rapor-container">
      <header className="rapor-header">
        <div className="rapor-header-content">
          <div>
            ...
            <h1>Kategori Bazlı Satış Raporu</h1>
          </div>
          <div className="nav-menu-container">
            ...
            {showNavMenu && (
              <div className="nav-menu-dropdown">
                ...
                <Link to="/satis/kategori" className="nav-menu-item active" onClick={() => setShowNavMenu(false)}>
                  📦 Kategori Bazlı
                </Link>
      ...
      <div className="charts-grid">
        <div className="chart-card">
          <h2>Kategori Bazında Satış Adetleri</h2>
